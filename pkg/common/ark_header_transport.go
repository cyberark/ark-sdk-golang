...
//
// ArkHeaderTransport wraps an existing http.RoundTripper and automatically adds
...
//
// ArkBasicAuthTransport wraps an existing http.RoundTripper and automatically adds
