...
func TestNewArkBasicKeyring(t *testing.T) {
	tests := []struct {
		name         string
		setupFunc    func() (string, func()) // Returns temp dir and cleanup func
		envVar       string
		expectedNil  bool
		validateFunc func(t *testing.T, keyring *ArkBasicKeyring, tempDir string)
	}{
		{
...
func TestArkBasicKeyring_SetPassword(t *testing.T) {
	tests := []struct {
		name          string
		setupFunc     func() (*ArkBasicKeyring, func())
		serviceName   string
		username      string
		password      string
		expectedError bool
		validateFunc  func(t *testing.T, keyring *ArkBasicKeyring)
	}{
		{
...
func TestArkBasicKeyring_GetPassword(t *testing.T) {
	tests := []struct {
		name             string
		setupFunc        func() (*ArkBasicKeyring, func())
		serviceName      string
...
func TestArkBasicKeyring_DeletePassword(t *testing.T) {
	tests := []struct {
		name          string
		setupFunc     func() (*ArkBasicKeyring, func())
		serviceName   string
...
func TestArkBasicKeyring_Integration(t *testing.T) {
	tests := []struct {
		name         string
		actions      []func(*ArkBasicKeyring) error
		validateFunc func(t *testing.T, keyring *ArkBasicKeyring)
	}{
		{
			name: "integration_complete_lifecycle",
			actions: []func(*ArkBasicKeyring) error{
				func(k *ArkBasicKeyring) error { return k.SetPassword("service1", "user1", "pass1") },
				func(k *ArkBasicKeyring) error { return k.SetPassword("service1", "user2", "pass2") },
				func(k *ArkBasicKeyring) error { return k.SetPassword("service2", "user1", "pass3") },
				func(k *ArkBasicKeyring) error { return k.DeletePassword("service1", "user1") },
			},
			validateFunc: func(t *testing.T, keyring *ArkBasicKeyring) {
...
func patchBasicKeyringFileOps(b *ArkBasicKeyring, ops *mockFileOps) func() {
	origStat := osStat
	origRemove := osRemove
	osStat = ops.Stat
	osRemove = ops.Remove
...
func TestArkBasicKeyring_ClearAllPasswords(t *testing.T) {
	tests := []struct {
		name           string
		statErr        error
		removeKeyErr   error
