...
type ArkSecHubGetSyncPolicy struct {
	...
	Projection string `json:"projection" mapstructure:"projection" desc:"Data representation method. Allowed values: 'EXTEND, REGULAR'" default:"REGULAR" flag:"projection"`
}
