...
type ArkCmgrPoolIdentifier struct {
	ID        string `json:"id" mapstructure:"id" flag:"id" desc:"ID of the identifier"`
	PoolID    string `json:"pool_id" mapstructure:"pool_id" flag:"pool-id" desc:"ID of the pool this identifier is associated to"`
	Type      string `json:"type" mapstructure:"type" flag:"type" desc:"Type of the identifier" choices:"GENERAL_FQDN,GENERAL_HOSTNAME,AWS_ACCOUNT_ID,AWS_VPC,AWS_SUBNET,AZURE_SUBSCRIPTION,AZURE_VNET,AZURE_SUBNET,GCP_PROJECT,GCP_NETWORK,GCP_SUBNET"`
